...
cardekho_cleaned_df = spark.read.format("delta").load("/mnt/cardekho-raw/cardekho_silver_layer/car_age_added_delta/")
...
high_budget_cars_df.repartition(1).write.mode("overwrite").format('delta').save("/mnt/cardekho-raw/cardekho_gold_layer/high_budget_cars_delta/")
...
mid_range_budget_cars_df.repartition(1).write.mode("overwrite").format('delta').save("/mnt/cardekho-raw/cardekho_gold_layer/mid_range_budget_cars_delta/")
...
low_budget_cars_df.repartition(1).write.mode("overwrite").format('delta').save("/mnt/cardekho-raw/cardekho_gold_layer/low_budget_cars_delta/")
...
low_power_cars_df.repartition(1).write.mode("overwrite").format('delta').save("/mnt/cardekho-raw/cardekho_gold_layer/low_power_cars_delta/")
...
Mid_performance_cars_df.repartition(1).write.mode("overwrite").format('delta').save("/mnt/cardekho-raw/cardekho_gold_layer/Mid_performance_cars_delta/")
...
high_performance_cars_df.repartition(1).write.mode("overwrite").format('delta').save("/mnt/cardekho-raw/cardekho_gold_layer/high_performance_cars_delta/")
